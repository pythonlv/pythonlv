...
Together we agreed that hands-on is much more exciting then raw blah-blah-blah, 
and have completely switched to #PyNight format. Discussions and speakers always 
welcome as an addition to code.
We had lots of fun, coding together and late night techn'o'sophic chatting.

Projects
========
- abele_ , algaruda_ and Aleksejs still inspired by `Go Reactive Workshop`_ 
  and ReactiveX_ were digging into functional_, porting `ReactiveX tutorial`_ 
  to python_
- daGrevis_ and siers_ continued with pong-py_ implementation of Pong_ in 
  Brython_
